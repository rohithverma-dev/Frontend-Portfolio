  ...
  return loading ? (
    ...
    <div id="HOME" className="home">
      <div className="home-content">
        ...
        <p>
          <span>{homeProfile.home_about}</span>
        </p>
        ...
        <a href={`${homeProfile.resume}`} target="blank" className="btn">
          Download Resume
        </a>
        <a href="#CONTACT-PAGE" className="btn2">
          Hire Me Now
        </a>
    ...
    <a href="#" style="--i:10"><i className='bx bxl-'></i></a> */}
          ...
          <a
            href="https://github.com/rohithverma-dev"
            target="_blank"
            style={{ "--i": "7" }}
          >
